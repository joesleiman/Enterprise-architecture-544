package edu.miu.carRental.validation;
...
import edu.miu.carRental.exception.ValidationException;
...
public class ServiceValidationAspect {
	...
	@Pointcut("execution(* edu.miu.carRental.service..*(..))")
	public void applicationMethod() {
	}

	@Pointcut("@annotation(edu.miu.carRental.validation.ServiceValidation)")
