...
public interface BookingRepository extends JpaRepository<Booking, Long> {
	...
	public List<Booking> findAllByBookingDateOrStartDateOrEndDate(LocalDate bookingDate, LocalDate startDate,
			LocalDate endDate);

	public List<Booking> findAllByStartDateGreaterThanEqualAndEndDateLessThanEqual(LocalDate startDate,
			LocalDate endDate);
